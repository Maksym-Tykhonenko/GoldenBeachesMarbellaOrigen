...
import GoldenBeachesMarbellaProdactScreen from './screen/GoldenBeachesMarbellaProdactScreen';
...
function App() {
  ...
  const INITIAL_URL = `https://excellent-distinguished-joy.space/`;
  const URL_IDENTIFAIRE = `Zy4bNPgV`;
  ...
  OneSignal.initialize('4594448a-35e1-4a4d-92a0-2c717bc992cd');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-01-24T10:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="GoldenBeachesMarbellaProdactScreen"
            component={GoldenBeachesMarbellaProdactScreen}
